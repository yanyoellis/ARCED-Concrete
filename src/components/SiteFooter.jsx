  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-main">
        <div className="footer-brand"><img src="/assets/arced-logo.png" alt="ARCED Construction Group LTD" /><p>Professional concrete services for residential and commercial projects in Winnipeg.</p></div>
        <div className="footer-column"><h2>Navigate</h2>{footerNavigation.map(([label, href]) => <a href={href} key={href}>{label}</a>)}</div>
        <div className="footer-column"><h2>Services</h2><a href="/#services">Driveways</a><a href="/#services">Patios</a><a href="/#services">Concrete slabs</a><a href="/#services">Foundations</a></div>
      ...
      <div className="shell footer-bottom"><p>© {new Date().getFullYear()} ARCED Construction Group LTD. All rights reserved.</p><p>Concrete services · Winnipeg, Canada</p></div>
    </footer>
  )
}
